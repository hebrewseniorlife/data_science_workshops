...
# Using `dplyr` + `tidyr` to solve real problems
...
dt <- tibble(
  ...
  v1_gaitspeed = rnorm(100, mean = 1, sd = 0.2),
  # v1_gripstrength = rnorm(),
  v1_mri_available = rbinom(100, 1, 0.1),
  v2_gaitspeed = rnorm(100, mean = 1, sd = 0.2),
  v2_mri_available = rbinom(100, 1, 0.1)
)
```
